...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('invoices_change_status') }}" method="post" autocomplete="off">
                        {{ csrf_field() }}
                        {{-- 1 --}}
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="invoice_Date" placeholder="YYYY-MM-DD"
                                    type="date" value="{{ $invoice->invoice_Date }}" readonly>
                            </div>

                            <div class="col">
                                <label>تاريخ الاستحقاق</label>
                                <input class="form-control fc-datepicker" name="Due_date" placeholder="YYYY-MM-DD"
                                    type="date" value="{{ $invoice->Due_date }}" readonly >
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="section_id" class="form-control SlectBox" "
                                    readonly>
                                    <!--placeholder-->
                                    <option value="{{ $invoice->section->section_name }}" selected disabled> {{ $invoice->section->section_name }}</option>
                        ...
                        <div class="col-sm-12 col-md-12">
                            <input type="file" name="file" class="dropify"
                                accept=".pdf,.jpg, .png, image/jpeg, image/png" data-height="70" value="" />
                        </div><br> --}}
                         <div class="row">
                            <div class="col">
