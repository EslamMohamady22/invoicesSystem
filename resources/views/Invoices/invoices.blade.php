...
@section('content')
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ url('change_status_invoice/' . $invoice->id) }}"> تغير
                                                        حالة
                                                        الدفع </a>
                                                    <a class="dropdown-item" data-effect="effect-scale"
                                                        data-id="{{ $invoice->id }}" data-toggle="modal"
                                                        href="#modaldemo8"> نقل إلى الأرشيف </a>
                                                    <a class="dropdown-item"
                                                        href="{{ url('print_invoice/' . $invoice->id) }}">
                                                        طباعة الفاتورة
                                                         </a>
    ...
    <div class="modal" id="modaldemo8">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">ارشف الفاتورة</h6><button aria-label="Close" class="close" data-dismiss="modal"
                        type="button"><span aria-hidden="true">&times;</span></button>
                </div>
                <form action="{{ url('delete_invoice/' . $invoice->id) }}" method="post">
                    {{ csrf_field() }}
