                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                       ...
                                                       href="#modaldemo9">  حذف الفاتورة</a>
                                                            ...
                                                            <a class="dropdown-item" href="{{ url('restorarchive_invoice/'.$invoice->id) }}">  نقل إلى الفواتير   </a>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td></td>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content modal-content-demo">
                                <div class="modal-header">
                                    <h6 class="modal-title">حذف الفاتورة المؤرشفة</h6><button aria-label="Close" class="close" data-dismiss="modal"
                                    type="button"><span aria-hidden="true">&times;</span></button>
                                </div>
                                <form action="{{ url('delete_invoice_archive/'.$invoice->id) }}" method="post">
                                    {{csrf_field()}}
